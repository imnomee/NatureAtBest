        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "Hello ".concat(res.data.data.user.name, ". Logged In Successfully"));
              setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', "Incorret username or password");
...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoiaW1ub21lZSIsImEiOiJjazhxbWZxYzEwMTY4M3NxYXRqMTBtbWZwIn0.b6escU__K9468ByVZqI3hg';
  ...
  locations.forEach(function (loc) {
    ...
    new mapboxgl.Popup({
      offset: 30
    }).setLngLat(loc.coordinates).setHTML("<p>Day ".concat(loc.day, ": ").concat(loc.description, "</p>")).addTo(map); // extend the bounds to incllude current location
...
var stripe = Stripe('pk_test_2VoZBnt4T9Iy4zzC7oA4ZZ4u001rKpn1vl');
